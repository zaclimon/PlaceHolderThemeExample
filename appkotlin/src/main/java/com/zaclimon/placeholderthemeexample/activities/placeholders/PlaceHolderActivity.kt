package com.zaclimon.placeholderthemeexample.activities.placeholders
 ...
 */
abstract class PlaceHolderActivity : AppCompatActivity() {
    ...
    companion object {
        val LIGHT_THEME_PLACEHOLDER_COMPONENT_NAME = ".LightTheme.PlaceHolder"
        val DARK_THEME_PLACEHOLDER_COMPONENT_NAME = ".DarkTheme.PlaceHolder"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var activityBaseIntent = Intent(this, MainActivity::class.java)
        startActivity(activityBaseIntent)
        finish()
    }
